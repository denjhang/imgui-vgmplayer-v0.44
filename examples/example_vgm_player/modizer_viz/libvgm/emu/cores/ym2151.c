...
extern float g_ym2151_amplitude_multiplier;
            ...
            if (ofs_end>ofs_start)
                for (;;) {
                    for (int ii=0;ii<8;ii++) {
                        ...
                        val = (INT32)(val * g_ym2151_amplitude_multiplier);
                        m_voice_buff[m_voice_ofs+ii][(ofs_start>>MODIZER_OSCILLO_OFFSET_FIXEDPOINT)&(SOUND_BUFFER_SIZE_SAMPLE*4*2-1)]=LIMIT8(((val ) >>4));
                    }
