...
const std::vector<VGMPlayer::CHIP_DEVICE>& VGMPlayer::GetChipDevices(void) const
{
	return _devices;
}
...
void VGMPlayer::GenerateDeviceConfig(void)
{
	...
	for (vgmChip = 0x00; vgmChip < _CHIP_COUNT; vgmChip ++)
	{
		UINT32 chipCount = GetChipCount(vgmChip);
