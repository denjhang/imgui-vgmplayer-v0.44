...
static const char* ym2151_get_chip_name(const DEV_GEN_CFG* cfg)
{
	return devDef_YM2151_MAME.name;
}

static UINT16 ym2151_get_chn_count(const DEV_GEN_CFG* cfg)
{
	return 8;
}

static const DEV_DEF* ym2151_dev_cores[] =
{
	&devDef_YM2151_MAME,
	NULL
};
